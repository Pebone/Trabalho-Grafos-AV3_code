...
// import { musica } from "./assets/joguinho.mp3"
...
document.addEventListener("click", function () {
  setInterval(function () {
    var nodeElement21 = document.getElementById("node-24-20");
    nodeElement21.classList.add("areia4");
    var nodeElement21 = document.getElementById("node-20-24");
    nodeElement21.classList.add("areia4");
...
function dijkstra(startNode, endNode) {
  ...
  // console.log("Passando por:", currentNode);

  // Retorna a distância mínima até o ponto de destino
  //   console.log(endNode)
  var path = [];
  var currentPathNode = endNode;
  while (!isSameNode(currentPathNode, startNode)) {
    //     if (distances[endNode[0]][endNode[1]] - 1 === 0) {
    //       return {
...
function getPositionOnClick() {
  ...
  for (var i = 0; i < yellowElements.length; i++) {
    yellowElements[i].addEventListener("click", function () {
      ...
      console.log("Menor distância até o ponto:", shortestDistance);
      ...
      console.log("Menor distância até o ponto:", shortestDistance2);
      clearTimeout(timerId);
      ...
      if (shortestDistance.distance < shortestDistance2.distance) {
        ...
        setTimeout(() => {
          ...
          moveAmbulance2(positionSlowest2);
        }, 3000);
      } else {
      ...
      setTimeout(() => {
        ...
        // showPath(shortestDistance.path, "true");
        // showPath2(shortestDistance2.path, "true");
      }, 3000);
    });
  }
}
